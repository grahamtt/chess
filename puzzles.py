...
PUZZLE_DATABASE: list[Puzzle] = [
    ...
    Puzzle(
        ...
        fen="r1bk2nr/pppp1Qpp/2n5/4p3/2B1P3/8/PPPP1PPP/RNB1K2R w KQ - 0 1",
        description="White has a mating attack with queen and bishop. The knight on g8 blocks the rook!",
        category=PuzzleCategory.CHECKMATE,
